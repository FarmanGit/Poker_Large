...
using namespace std;
    ...
    double VisitorConcret::calculer(QuinteF combi, std::vector<Carte> lesCartes)
    {
        ...
        {
            if(lesCartes.at(i).getCouleur().getName()=="clubs")
            {
                trefle++;
            }
            if(lesCartes.at(i).getCouleur().getName()=="diamonds")
            {
                carreau++;
            }
            if(lesCartes.at(i).getCouleur().getName()=="spades")
            {
                pic++;
            }
            if(lesCartes.at(i).getCouleur().getName()=="hearts")
            {
                coeur++;
            }
