...
using namespace std;
    ...
    //fonction renvoyant true si la mise est valide (sup�rieure ou egale a celle des autres joueurs)
    ...
    //fonction principale gerant le d�roulement du jeu
    void Partie::commencer()
    {
        ...
        do
        {
            ...
            cout<< "The dealer is : "<<lesJoueurs_.at(dealer_).getName()<<endl;
            leJeu_.melanger();
            distribuer();
            cout << "Your hand :"<<endl;
                ...
                if (joueursEnJeu()!=1)
                {
                    ...
                    if (joueursEnJeu()!=1)
                    {
                        ...
                        if (joueursEnJeu()!=1)
                        {
                            showdown();
                            int winner=gagnant();
                            cout << lesJoueurs_.at(winner).getName() << " wins" << endl;
            ...
            for (unsigned int i=0;i<lesJoueurs_.size();i++)
            {
                if (lesJoueurs_.at(i).getJetons()==0)
                {
                    ...
                    if(((lesJoueurs_.at(i).getName().compare("Alphonse")) != 0) && ((lesJoueurs_.at(i).getName().compare("Bebert")) != 0 ) && ((lesJoueurs_.at(i).getName().compare("Charles")) != 0) && ((lesJoueurs_.at(i).getName().compare("Dede")) !=0))
                    {
                    	stop = true;
                    	cout << "=======================================================";
                    }
        ...
        while(!stop && nbLooser()<lesJoueurs_.size()-1);
//        while(nbLooser()<lesJoueurs_.size());
    ...
    //fonction appel�e lorsqu'il ne reste plus qu'un seul joueur en jeu
