...
using namespace std;
    ...
    //fonction charg�e de demande a l'utilisateur son choix lors du 1er tour de mise
    ...
    int Humain::mise()
    {
        ...
        case(2):
            do
            {
                cout<<"How much do you want to bid ? ("<< leJoueur_->getLaPartie()->getJoueur(4).getJetons() << " chips)" << endl;
                cin>>mise;
            }
    ...
    //fonction charg�e de demande a l'utilisateur son choix lors du 2eme tour de mise
